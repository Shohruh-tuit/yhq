...
import 'package:yhq/cards/Card_1/inCards/inCard_1-3.dart';
import 'package:yhq/cards/Card_1/inCards/inCard_1-4.dart';
import 'package:yhq/constants/colors.dart';

class Card1_4 extends StatefulWidget {
  static final String id = "card_1-4";

  @override
  _Card1_4State createState() => _Card1_4State();
}

class _Card1_4State extends State<Card1_4> {
  @override
                  ...
                  child: InkWell(
                    ...
                    onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => InCard1_4(index)));
                    },
                  ),
                );
              },
