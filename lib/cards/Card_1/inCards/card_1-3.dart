...
class Card1_3 extends StatefulWidget {
  static final String id = "card_1-3";

  @override
  _Card1_3State createState() => _Card1_3State();
}

class _Card1_3State extends State<Card1_3> {
  @override
                  ...
                  child: InkWell(
                    ...
                    onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => InCard1_3(index)));
                    },
                  ),
                );
              },
