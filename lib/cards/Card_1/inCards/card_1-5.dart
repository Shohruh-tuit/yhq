...
class Card1_5 extends StatefulWidget {
  static final String id = "card_1-5";

  @override
  _Card1_5State createState() => _Card1_5State();
}

class _Card1_5State extends State<Card1_5> {
  @override
                  ...
                  child: InkWell(
                    ...
                    onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => InCard1_5(index)));
                    },
                  ),
                );
              },
